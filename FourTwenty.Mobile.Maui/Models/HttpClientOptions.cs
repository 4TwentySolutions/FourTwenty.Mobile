...
namespace FourTwenty.Mobile.Maui.Models
{
    ...
    {
        public HttpClientOptions(Uri? baseAddress, HttpMessageHandler? messageHandler = null, Priority priority = Priority.UserInitiated, Func<HttpRequestMessage, Task<string>>? authToken = null)
        {
